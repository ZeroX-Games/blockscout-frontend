...
| NEXT_PUBLIC_NEW_API_HOST | `string` | Main API host | Required | - | `localhost` |
| NEXT_PUBLIC_NEW_API_PORT | `number` | Port where API is running on the host | - | - | `8000` |
...
| Variable | Type| Description | Compulsoriness  | Default value | Example value |
| --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_HOMEPAGE_CHARTS | `Array<'daily_txs' \| 'coin_price' \| 'market_cap' \| 'tvl' \| 'daily_updates'>` | List of charts displayed on the home page | - | - | `['daily_txs','coin_price','market_cap','daily_updates']` |
...
| NEXT_PUBLIC_MARKETPLACE_SUBMIT_FORM | `string` | Utils to form where authors can submit their dapps to the marketplace | Required | - | `https://airtable.com/shrqUAcjgGJ4jU88C` |
| NEXT_PUBLIC_NETWORK_RPC_URL | `string` | See in [Blockchain parameters](ENVS.md#blockchain-parameters) section | Required | - | `https://core.poa.network` |
