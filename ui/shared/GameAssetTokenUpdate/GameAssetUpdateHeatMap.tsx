...
import GameAssetUpdateDrawer from './GameAssetUpdateDrawer';
...
const GameAssetUpdateHeatMap = () => {
  ...
  return (
    <>
      <GameAssetUpdateDrawer onClose={ onClose } isOpen={ isOpen }/>
      <ResponsiveHeatMap
        data={ data }
        theme={
          {
...
export default GameAssetUpdateHeatMap;
