...
// deprecated
const GameAssetTokenUpdateTable = ({
  query,
}: Props) => {
  ...
  const mockData: Array<GameAssetTokenUpdate> = [ { id: (Math.floor(Math.random() * 300) + 100).toString(), updates: [ 0, -43, 0, 55, 53, 0, 12 ], name: 'a' },
...
export default React.memo(GameAssetTokenUpdateTable);
