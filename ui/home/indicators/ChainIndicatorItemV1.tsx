...
interface Props {
  ...
  stats: UseQueryResult<HomeSummary, ResourceError<unknown>>;
}

const ChainIndicatorItemV1 = ({ id, title, value, icon, isSelected, onClick, stats }: Props) => {
...
export default React.memo(ChainIndicatorItemV1);
