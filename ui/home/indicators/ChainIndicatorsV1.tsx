...
import { HOME_SUMMARY } from 'stubs/stats';
import Hint from 'ui/shared/Hint';

import useApiQueryV1 from '../../../lib/api/v1/useApiQueryV1';
import ChainIndicatorChartContainer from './ChainIndicatorChartContainer';
import ChainIndicatorItemV1 from './ChainIndicatorItemV1';
import useFetchChartDataV1 from './useFetchChartDataV1';
import { INDICATORSV1 } from './utils/indicators';

const indicators = INDICATORSV1
...
const ChainIndicatorsV1 = () => {
  ...
  const queryResult = useFetchChartDataV1(indicator as TChainIndicatorV1<'homepage_chart_updates'> |undefined);
  const statsQueryResult = useApiQueryV1('homepage_summary_stat', {
    fetchParams: {
      headers: {
...
export default ChainIndicatorsV1;
